...
// Add these to LETUP_CONFIG at the top of the file
LETUP_CONFIG.showWatermark = true;                    // Enable watermark by default
LETUP_CONFIG.watermarkText = "Powered by Letup";      // Default watermark text
LETUP_CONFIG.watermarkUrl = "https://letup.com";      // Default watermark URLLETUP_CONFIG.enableAggregateNotifications = true;    // Set to false to disable aggregate count notifications
